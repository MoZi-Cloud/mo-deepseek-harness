...
// docs/mozi-fork/ holds this fork's internal process records; review reports must keep literal commit hashes.
const excludedPrefixes = ['vendor/', '.agents/notes/archived/', 'docs/mozi-fork/'] as const
