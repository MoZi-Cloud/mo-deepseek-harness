...
const NO_MODEL_EXPERIENCE_SECTION: Readonly<Record<string, string>> = {
  ...
  'packages/experimental/observatory-protocol': 'The package validates offline research documents; it registers nothing model-facing.',
...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/util/content-scan': { kind: 'none', reason: 'The scanner returns findings to its caller; the consuming gates own every model-facing rejection.' },
