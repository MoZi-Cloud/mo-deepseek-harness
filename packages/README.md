...
| [`review/`](review/README.md) | Session review family: consolidates finished sessions into memory and managed skills (skeleton) |
| [`memory/`](memory/README.md) | Durable memory capability: per-scope recall with anti-replay receipts and snapshot publication |
